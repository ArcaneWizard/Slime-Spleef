...
public static class Constants 
{
    ...
    public static Vector3 WorldGravity = 31f * new Vector3(0, -0.707f, 0.707f);

    public static Vector2 MapXBounds = new Vector2(-50f, 50f);
    public static Vector2 MapYBounds = new Vector2(-50f, 50f);
